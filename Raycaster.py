...
class Raycaster():
    ...
    def cast_rays(self):
        ...
        for rays in range(self.rays_casted):
            ...
            Y_HOR,DY=(PLAYER_MAPY+1,1) if math.sin(start_angle)>0 else (PLAYER_MAPY-0,0001,-1)
            ...
            X_VERT,DX= (PLAYER_MAPX+1,1) if math.cos(start_angle)>0 else (PLAYER_MAPX-0,0001,-1)
            ...
            pg.draw.line(DISPLAY,'green',(100*PLAYER_X,100*PLAYER_Y),(100*PLAYER_X+100*DEPTH*math.cos(start_angle),100*PLAYER_Y+100*DEPTH*math.sin(start_angle)),2)
